- Une technique très populaire et efficace pour ajouter une touche d'élégance à une interface, que ce soit pour des icônes, des logos ou des animations de chargement. C'est un super effet à ajouter à un portfolio !
...
<style>
  .cercle {
    ...
    stroke-width: 10;
    fill: transparent;
    /* La circonférence est d'environ 628 */
    stroke-dasharray: 628;
    stroke-dashoffset: 628;
    animation: dessine-cercle 2s forwards;
  }

  @keyframes dessine-cercle {
    to {
      stroke-dashoffset: 0;
    }
  }
...
<svg width="220" height="220">
  <circle class="cercle" cx="110" cy="110" r="100" />
</svg>

- Avec la version source
  ...
  style="width: 457px; height: 526px; opacity: 0.6;"
...
.visage-anime {
/_ Valeurs initiales pour l'animation _/
stroke-dasharray: 1; /_ Un tiret unique de la longueur du tracé (grâce à pathLength="1") _/
stroke-dashoffset: 1; /_ On décale le tiret pour le cacher _/

    /* On déclenche l'animation */
    animation: dessiner 3s ease-in-out forwards;

}

@keyframes dessiner {
to {
stroke-dashoffset: 0; /_ On ramène le tiret à sa position d'origine _/
}
}
